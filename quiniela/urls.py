...
urlpatterns = \
    [
        ...
        url(r'^games/(?P<qt_id>[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12})$', page_not_found, name='games'), # views.gamesView for enable upload, page not found disable
